...
bin/ModeGraphique : obj/mainGraphique.o obj/JeuModeGraphique.o obj/Case.o obj/Effet.o obj/Jeton.o obj/Jeu.o obj/Joueur.o obj/Plateau.o obj/Score.o
	g++ -g -Wall obj/mainGraphique.o obj/JeuModeGraphique.o obj/Case.o obj/Effet.o obj/Jeton.o obj/Jeu.o obj/Joueur.o obj/Plateau.o obj/Score.o -o bin/ModeGraphique -lSDL2 -lSDL2_ttf -lSDL2_image
...
obj/Plateau.o : src/Plateau.cpp src/Plateau.h src/Case.h 
	g++ -g -Wall -c src/Plateau.cpp -o obj/Plateau.o -lSDL2 -lSDL2_ttf -lSDL2_image
